 ...
 */
public class ComparableLinkedList <T extends Comparable<T>> implements ListInterface<T>{
    Node firstNode;
    Node lastNode;
    ...
    @Override
    public ComparableLinkedList getSortedList() {
        ComparableLinkedList<T> ascendingSortedList = new ComparableLinkedList<T>();
        if(!isEmpty()){
    ...
    @Override
    public ComparableLinkedList getSortedList(Comparator comparator) {
        ComparableLinkedList<T> ascendingSortedList = new ComparableLinkedList<T>();
        if(!isEmpty()){
            ascendingSortedList.firstNode = new Node(this.firstNode.data);
            ascendingSortedList.lastNode = ascendingSortedList.firstNode;
    ...
    @Override
    public boolean merge(ListInterface<T> list) {
        ComparableLinkedList<T>  anotherList = (ComparableLinkedList<T>) list;
